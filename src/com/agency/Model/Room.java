...
public class Room {
    ...
    public Room(String roomType, int stockCount, int hotelID, int roomID, int bedCount, int hasTv, int hasMinibar, int hasGameConsole, int hasVault, int hasProjection, int roomSizeM) {
    ...
    public static boolean addRoom(String room_type,int stock_count,int hotel_id,int bed_count,int has_tv,int has_mini_bar,int has_game_console,int has_vault,int has_projection,int room_size_m){
        String query = "INSERT INTO rooms (room_type,stock_count,hotel_id,bed_count,has_tv,has_mini_bar,has_game_console,has_vault,has_projection,room_size_m) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public static ArrayList<Room> getRoomList(){
        ...
        try {
            ...
            while (rs.next()){
                obj = new Room(rs.getString("room_type"),rs.getInt("stock_count"),rs.getInt("hotel_id"),rs.getInt("room_id"),rs.getInt("bed_count"),rs.getInt("has_tv"),rs.getInt("has_mini_bar"),rs.getInt("has_game_console"),rs.getInt("has_vault"),rs.getInt("has_projection"),rs.getInt("room_size_m"));
                roomList.add(obj);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
